...
#bla = randht(5891,'cutoff',3,2,1.0/9);		#group size MIT
#bla = randht(5891,'cutoff',3,2.3,1.0/35);	#group size Dartmouth
#bla = randht(1000000,"exponential",0.2)    
#bla = randht(10500,'cutoff',550,2.1,1.0/(6*3600));	#
#for i in bla:
#	print(i)
